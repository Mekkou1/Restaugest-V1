    ...
    <div class="gestion-devises">
      ...
      <div class="devises-grid">
        <div 
          ...
          :key="devise.id"
          class="devise-card"
          :class="{ 'devise-principale': devise.principale }"
        >
          <div class="devise-header">
            <div class="devise-info">
              ...
              <span 
                v-if="devise.principale"
                class="badge-principale"
              >
                Devise principale
              </span>
            </div>
          ...
          <div class="devise-content">
            <div class="taux-section">
              ...
              <small class="update-info">
                Mis à jour le {{ formatDate(devise.date_maj) }}
              </small>
            </div>
          ...
          <div class="devise-footer">
            <label class="toggle-switch">
              <input 
                type="checkbox"
                v-model="devise.active"
                @change="toggleDevise(devise)"
              >
              <span class="slider"></span>
              <span class="toggle-label">
                {{ devise.active ? 'Activée' : 'Désactivée' }}
              </span>
            </label>
          </div>
        </div>
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">
                {{ editingDevise ? 'Modifier la devise' : 'Nouvelle devise' }}
              </h5>
              <button 
                type="button" 
                class="btn-close"
                ...
                <div class="form-row">
                  <div class="form-group">
                    ...
                    <div class="taux-input">
                      ...
                      <input 
                        type="number" 
                        v-model.number="deviseForm.taux"
                        class="form-control"
                        step="0.0001"
                        min="0"
                        required
                  ...
                  <div class="form-group">
                    ...
                    <input 
                      type="number" 
                      v-model.number="deviseForm.decimales"
                      class="form-control"
                      min="0"
                      max="4"
                      required
            ...
            <div class="modal-footer">
              ...
              >
                {{ editingDevise ? 'Enregistrer' : 'Ajouter' }}
              </button>
            </div>
          </div>
        </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>
                ...
                <strong>{{ deviseToDelete?.code }}</strong> ?
              </p>
